...
| `example.containerImage`                                    | Example container image name                                                                                                                  | `onlyoffice/docs-example:7.1.1-1`            |
| `example.imagePullPolicy`                                   | Example container image pull policy                                                                                                           | `IfNotPresent`                               |
| `example.dsUrl`                                             | Documentserver address (needed for the conversion to work correctly in Example (http://<documentserverDomain>/)                               | `/`                                          |
...
| `docservice.containerImage`                                 | Docservice container image name                                                                                                               | `onlyoffice/docs-docservice-de:7.1.1-1`      |
...
| `proxy.proxyContainerImage`                                 | Docservice Proxy container image name                                                                                                         | `onlyoffice/docs-proxy-de:7.1.1-1`           |
...
| `converter.containerImage`                                  | Converter container image name                                                                                                                | `onlyoffice/docs-converter-de:7.1.1-1`       |
...
| `upgrade.job.image.repository`                              | Job by upgrade image repository. If `privateCluster=true` is set, the image must have `curl` and `psql` installed. The image must be run either from `root` or from `UID=101`  | `postgres`                                   |
| `upgrade.job.image.tag`                                     | Job by upgrade image tag                                                                                                                                                       | `latest`                                     |
...
| `rollback.job.image.repository`                             | Job by rollback image repository. If `privateCluster=true` is set, the image must have `curl` and `psql` installed. The image must be run either from `root` or from `UID=101` | `postgres`                                   |
| `rollback.job.image.tag`                                    | Job by rollback image tag                                                                                                                                                      | `latest`                                     |
...
| `delete.job.image.repository`                               | Job by delete image repository. If `privateCluster=true` is set, the image must have `curl` and `psql` installed. The image must be run either from `root` or from `UID=101`   | `postgres`                                   |
| `delete.job.image.tag`                                      | Job by delete image tag                                                                                                                                                        | `latest`                                     |
